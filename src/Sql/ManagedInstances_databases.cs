...
namespace AzureDesignStudio.AzureResources.Sql
{
    ...
    public partial class ManagedInstances_databases : ResourceBase
    {
        [Required]
        ...
        public IList<ManagedInstances_databases_backupShortTermRetentionPolicies> Resources { get; set; }
